...
%     \textbf{\MakeUppercase{the HADES Experiment}} \\[0.5\baselineskip] }
	...
	{\Large {FIRST LINE OF THE TITLE} \\[0.3\baselineskip] %
		{SECOND LINE OF THE TITLE} \\[0.3\baselineskip]
	}
...
%   \vspace{20pt} % Whitespace between editor names and publisher logo
  ...
  {\scshape YEAR OF YOUR HAPPINES} \\[0.3\baselineskip] % Year published }
